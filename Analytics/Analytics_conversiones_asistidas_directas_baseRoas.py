...
#Hot Sale
analytics = Analytics(mes = 'Hot Sale')
...
tmp = analytics.groupby(['inicio_reporte'],as_index = False).count()
...
def Escritura(Base, hoja, header = False, Escribir = 'no'):
    ...
    if Escribir == 'si':
        ...
        sh = client.open('Base Master Roas Hot Sale') #Recordar que el archivo que deseamos leer tiene que tener el correo de la api como persona compartida
